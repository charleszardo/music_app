...
ActiveRecord::Schema.define(version: 20161219154423) do
  ...
  add_index "taggings", ["tagging_id", "tagging_type"], name: "index_taggings_on_tagging_id_and_tagging_type", using: :btree
